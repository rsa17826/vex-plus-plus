...
func generateBlockOpts():
  ...
  blockOptions.startWhenSignalReceived = {
    "default": false,
    "type": global.PromptTypes.bool,
    'onChange': func(val):
      if val:
        selectedOptions.startWhileSignalReceived = false
        # selectedOptions.startWhilePressedBackWhileNotPressed = false
      return true,
  }
  blockOptions.startWhileSignalReceived = {
    "default": false,
    "type": global.PromptTypes.bool,
    'onChange': func(val):
      if val:
        selectedOptions.startWhenSignalReceived = false
        # selectedOptions.startWhilePressedBackWhileNotPressed = false
      return true,
  }
  ...
  blockOptions.signalInputId = {
    ...
    "default": 0,
    'showIf': func():
      return selectedOptions.startWhenSignalReceived \
      or selectedOptions.startWhileSignalReceived,
  }
  blockOptions.restart = {
    ...
    "values": Restarts,
    'showIf': func():
      return selectedOptions.startWhileSignalReceived or selectedOptions.startWhenSignalReceived,
  }
  ...
  if id == selectedOptions.signalInputId:
    if on:
      ...
      if started:
        ...
        if selectedOptions.restart == Restarts.always or selectedOptions.startWhileSignalReceived:
      ...
      if selectedOptions.startWhileSignalReceived:
        started = false
